...
const (
	...
	GreetService_SayHelloBidirecttionalStreaming_FullMethodName = "/greet_service.GreetService/SayHelloBidirecttionalStreaming"
)
...
type GreetServiceClient interface {
	...
	SayHelloBidirecttionalStreaming(ctx context.Context, opts ...grpc.CallOption) (GreetService_SayHelloBidirecttionalStreamingClient, error)
}
...
func (c *greetServiceClient) SayHelloBidirecttionalStreaming(ctx context.Context, opts ...grpc.CallOption) (GreetService_SayHelloBidirecttionalStreamingClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[2], GreetService_SayHelloBidirecttionalStreaming_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &greetServiceSayHelloBidirecttionalStreamingClient{stream}
	return x, nil
}

type GreetService_SayHelloBidirecttionalStreamingClient interface {
	Send(*HelloRequest) error
	Recv() (*HelloResponse, error)
	grpc.ClientStream
}

type greetServiceSayHelloBidirecttionalStreamingClient struct {
	grpc.ClientStream
}

func (x *greetServiceSayHelloBidirecttionalStreamingClient) Send(m *HelloRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServiceSayHelloBidirecttionalStreamingClient) Recv() (*HelloResponse, error) {
	m := new(HelloResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type GreetServiceServer interface {
	...
	SayHelloBidirecttionalStreaming(GreetService_SayHelloBidirecttionalStreamingServer) error
...
func (UnimplementedGreetServiceServer) SayHelloBidirecttionalStreaming(GreetService_SayHelloBidirecttionalStreamingServer) error {
	return status.Errorf(codes.Unimplemented, "method SayHelloBidirecttionalStreaming not implemented")
}
...
func _GreetService_SayHelloBidirecttionalStreaming_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).SayHelloBidirecttionalStreaming(&greetServiceSayHelloBidirecttionalStreamingServer{stream})
}

type GreetService_SayHelloBidirecttionalStreamingServer interface {
	Send(*HelloResponse) error
	Recv() (*HelloRequest, error)
	grpc.ServerStream
}

type greetServiceSayHelloBidirecttionalStreamingServer struct {
	grpc.ServerStream
}

func (x *greetServiceSayHelloBidirecttionalStreamingServer) Send(m *HelloResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServiceSayHelloBidirecttionalStreamingServer) Recv() (*HelloRequest, error) {
	m := new(HelloRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "SayHelloBidirecttionalStreaming",
			Handler:       _GreetService_SayHelloBidirecttionalStreaming_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
